...
export const ProductUpdate = ({ solutionData, productId, getDevelopers }) => {
  ...
  const developerData = getDevelopers.find(developer => developer.n_id === solutionData.n_id);
  ...
  const handleDevIntroUpdate = async (e) => {
    ...
    if (developerData === undefined) {
      alert("개발자로 등록되지 않아서, 소개글을 수정할 수 없습니다. 담당자에게 개발자 등록요청해주세요.");
                  ...
                  <div className="imgBtn">
                    <div>
                      ...
                      <label htmlFor="fileInput">
                        <Button fullWidth component="span" variant="contained">이미지 선택</Button>
                      </label>
                    </div>
                    <div>
